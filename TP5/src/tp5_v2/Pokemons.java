...
public class Pokemons {
		...
		if(this.diurne == true) {
			if(this.monJoueur != null)
				if(this.nomDonne != null)
					...
					return "Pokemon[" + this.nom+", " + this.type + ", " + this.niveau + ", diurne, " + this.monJoueur.getNom() + ", " + this.appetit + ", "+ this.loyaute + "]" ;
			else
				return "Pokemon[" + this.nom+", " + this.type + ", " + this.niveau + ", diurne, " + this.appetit + ", "+ this.loyaute + "]" ;
		}
		
		else {
			if(this.monJoueur != null)
				if(this.nomDonne != null)
					return "Pokemon[" + this.nom+", " + this.type + ", " + this.niveau + ", nosturne, " + this.nomDonne + ", " + this.monJoueur.getNom() + ", " + this.appetit + ", "+ this.loyaute + "]" ;
				else
					return "Pokemon[" + this.nom+", " + this.type + ", " + this.niveau + ", nocturne, " + this.monJoueur.getNom() + ", " + this.appetit + ", "+ this.loyaute + "]" ;
			else
				return "Pokemon[" + this.nom+", " + this.type + ", " + this.niveau + ", nocturne, " + this.appetit + ", "+ this.loyaute + "]" ;
		}
	}
	...
	public void manger(Nourriture nourriture) {
		if(nourriture.isCompatible(this))
			...
			System.out.println("Ce se pokemon n'est pas compatible avec cette nourriture.");
	}

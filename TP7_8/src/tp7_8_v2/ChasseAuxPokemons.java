...
public class ChasseAuxPokemons {
	...
	public static void main(String[] args) {
		...
		final Joueur moi = new Joueur("De Pellegrin", "Remi", 20, new Pokemons[] {piplup, rowlet, totodile, null, null});
		...
		final Outils marteau = new Outils("Le petit marteau des Merveilles", 10, 2);
		...
		moi.donnerItem(0, 0);
		moi.afficherSac();
		moi.modifierItem(1, 0);
		moi.afficherSac();
/* La balle a bien changé de nom 	*/
